#!/usr/bin/env bash
# Build the debug APKs in a container (no Android tooling needed on the host).
# Outputs:
...
#   dist/yt-zero-screen-phone.apk       → / page, portrait + non-fullscreen (phone)
...
echo "==> Assembling debug APKs (tv + watch + phone flavors)…"
...
cp app/build/outputs/apk/phone/debug/app-phone-debug.apk dist/yt-zero-screen-phone.apk
echo "==> Done:"
